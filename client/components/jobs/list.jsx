    ...
    return (
      <div>
        <div className="container">
          <div className="row">
            <div className="twelve columns">
              <form onSubmit={this.searchJobs}>
                <input type="text" id="search-query" className="u-full-width" placeholder="Type something (e.g. Teacher or Design) and press enter" onChange={this.watchSearchQuery}/>
              </form>
            </div>
          </div>
             <div>
          <div className="row">
            <div className="twelve columns">
              <div className="alert sponsored">
                <b>Sponsored:</b> Javascript developer needed for small startup in Futian - please <a href="https://ffffff1.typeform.com/to/dITZGk">click here</a>.
                </div>
              </div>
            </div>
          </div>
