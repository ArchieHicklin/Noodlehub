...
Meteor.methods({
  'jobs.add': (job) => {
    ...
    if (Meteor.isServer) {
      Meteor.defer(() => {
        Email.send({
          from: 'Archie at Noodle Hub <noreply@noodlehub.com>',
          to: job.email,
          bcc: 'afphicklin@gmail.com',
          subject: 'Thank you for posting your job "' + job.title + '" on Noodle Hub',
          html: '' +
            '<b>Note: Keep this E-Mail as it gives you the possibility to activate, update and remove the job posting.</b>' +
            '<br /><br />' +
            'Please click the link below to <b>activate</b> your job posting: <br />' +
            ...
            '<br /><br />' +
            '<b>Update</b> or <b>remove</b> your job posting with these links: <br />' +
